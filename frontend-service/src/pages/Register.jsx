...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      await commandClient.post("/auth/register", {
        nombre,
        correo,
      ...
      const msg = Array.isArray(detail)
        ...
        : detail || "Ocurrió un error al intentar crear tu cuenta.";
      Swal.fire({
        title: "Error",
        text: msg,
        icon: "error",
      ...
      <div className="register-content">
        <div className="register-left">
          ...
          <h2 className="register-subtitle">
            Únete a nuestra plataforma y empieza a{" "}
            <span className="highlight-text">crecer.</span>
          </h2>
